package pe.edu.cibertec.appnote.data.database.impl.dao;
...
public final class NoteRoomDao_Impl implements NoteRoomDao {
  ...
  public NoteRoomDao_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR ABORT INTO `notes_table` (`id`,`title`,`content`) VALUES (nullif(?, 0),?,?)";
      }
    ...
    this.__updateAdapterOfNote = new EntityDeletionOrUpdateAdapter<Note>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `notes_table` SET `id` = ?,`title` = ?,`content` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object createNote(final Note note, final Continuation<? super Unit> continuation) {
